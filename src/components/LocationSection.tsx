...
const venues: Venue[] = [
  ...
  },
  {
    ...
    time: '7:00 PM',
    mapUrl:
      'https://maps.google.com/?q=Campery+Club+Ometepec+Guerrero+Mexico',
    icon: '✦',
  },
]
          ...
          {venues.map(venue => (
            ...
            >
              ...
              <div
                ...
                style={{ backgroundColor: 'rgba(196,113,74,0.08)', borderBottom: '1px solid rgba(196,113,74,0.15)' }}
              >
              ...
              <div className="px-8 pb-8">
                ...
                >
                  ...
                  <svg
                    ...
                    style={{ opacity: 0.25 }}
                  >
                    <line x1="0" y1="70" x2="300" y2="70" stroke="#C4714A" strokeWidth="1" />
                    <line x1="150" y1="0" x2="150" y2="140" stroke="#C4714A" strokeWidth="1" />
                    <line x1="0" y1="35" x2="300" y2="35" stroke="#6B7645" strokeWidth="0.5" strokeDasharray="4,6" />
                    <line x1="0" y1="105" x2="300" y2="105" stroke="#6B7645" strokeWidth="0.5" strokeDasharray="4,6" />
                    <line x1="75" y1="0" x2="75" y2="140" stroke="#6B7645" strokeWidth="0.5" strokeDasharray="4,6" />
                    <line x1="225" y1="0" x2="225" y2="140" stroke="#6B7645" strokeWidth="0.5" strokeDasharray="4,6" />
                    <circle cx="150" cy="70" r="8" fill="#C4714A" opacity="0.8" />
                    <circle cx="150" cy="70" r="16" fill="none" stroke="#C4714A" strokeWidth="1" opacity="0.4" />
                    <circle cx="150" cy="70" r="26" fill="none" stroke="#C4714A" strokeWidth="0.5" opacity="0.2" />
                  </svg>
                  <div
